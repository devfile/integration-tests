...
rm $GOPATH/src/github.com/openshift/odo/tests/integration/devfile/cmd_devfile_*_test.go
cp tests/integration/devfile/cmd_devfile_*_test.go $GOPATH/src/github.com/openshift/odo/tests/integration/devfile/
